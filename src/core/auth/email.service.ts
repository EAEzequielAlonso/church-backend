...
export class EmailService {
  ...
  async sendPasswordResetEmail(email: string, token: string): Promise<boolean> {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
        ...
        <p style="color: #475569; font-size: 16px; text-align: center;">
          Recibimos una solicitud para restablecer la contraseña de tu cuenta en Telyon. Puedes hacerlo haciendo clic en el siguiente enlace:
        </p>
        <div style="text-align: center; margin: 30px 0;">
        ...
        <p style="color: #64748b; font-size: 14px; text-align: center;">
          Este enlace expirará en 15 minutos. Si no solicitaste un cambio de contraseña, puedes ignorar este mensaje de forma segura.
        </p>
      </div>
    `;
  ...
  private logNotificationToConsole(
    ...
    this.logger.log(`[EMAIL FALLBACK] Message: ${message}`);
    this.logger.log('=============================================\n');
  }
}
