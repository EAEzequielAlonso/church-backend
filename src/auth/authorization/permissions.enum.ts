export enum AppPermission {
  ...
  MEMBER_ECCLESIASTICAL_ROLE_MANAGE = 'MEMBER_ECCLESIASTICAL_ROLE_MANAGE',
  MEMBER_FUNCTIONAL_ROLE_MANAGE = 'MEMBER_FUNCTIONAL_ROLE_MANAGE',
  MEMBERSHIP_REQUEST_VIEW = 'MEMBERSHIP_REQUEST_VIEW',
  MEMBERSHIP_REQUEST_MANAGE = 'MEMBERSHIP_REQUEST_MANAGE',
  ...
  // --- Worship / Services ---
  WORSHIP_VIEW = 'WORSHIP_VIEW',
  WORSHIP_TEMPLATE_MANAGE = 'WORSHIP_TEMPLATE_MANAGE',
  WORSHIP_MANAGE = 'WORSHIP_MANAGE',
  WORSHIP_PUBLISH = 'WORSHIP_PUBLISH',
  WORSHIP_EXPORT = 'WORSHIP_EXPORT',
}
