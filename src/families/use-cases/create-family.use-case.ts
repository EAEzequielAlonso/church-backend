        ...
        return this.dataSource.transaction(async (manager) => {
            ...
            for (const memberDto of createDto.members) {
                ...
                if (!memberId && memberDto.newMember) {
                    ...
                    const newMember = await this.membersService.create(memberDto.newMember, churchId, manager);
