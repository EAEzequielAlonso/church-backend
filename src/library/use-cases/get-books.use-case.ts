...
export class GetBooksUseCase {
  ...
  async execute(
    ...
    if (filters.isChurchOwned !== undefined) {
      query.andWhere('book.isChurchOwned = :isChurchOwned', {
        isChurchOwned: filters.isChurchOwned,
      });
    }
    ...
    if (filters.availability === 'AVAILABLE') {
      query.andWhere('book.status = :availStatus', {
        availStatus: BookStatus.AVAILABLE,
      });
